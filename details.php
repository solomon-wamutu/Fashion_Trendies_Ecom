          ...
          <div class="col-sm-6"><!-- col-sm-6 Starts -->
            ...
            <div class="box"><!-- box Starts -->
              ...
              if (isset($_POST['add_cart'])) {
                ...
                if (isset($_POST['product_qty']) && is_numeric($_POST['product_qty'])) {
                  ...
                  if ($product_qty > 0) {
                    ...
                    // Display error message if product quantity is not valid
                    echo "<script>alert('Please select a valid quantity')</script>";
                    echo "<script>window.open('$pro_url','_self')</script>";
                  }
                } else {
                  // Display error message if product quantity is not numeric
                  echo "<script>alert('Please select a valid quantity')</script>";
                  echo "<script>window.open('$pro_url','_self')</script>";
                }
              }
